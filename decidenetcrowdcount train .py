...
kb = keras.callbacks.TensorBoard(log_dir='./logs/mcnn_zhang_aes', histogram_freq=0, batch_size=32, write_graph=True, write_grads=False, write_images=False, embeddings_freq=0, embeddings_layer_names=None, embeddings_metadata=None, embeddings_data=None, update_freq='epoch')
...
plt.imshow(y_train[0].reshape(64,64), alpha=0.7)
plt.show()

plt.imshow(x_train[ll].reshape(256,256))
plt.imshow(y_train[ll].reshape(64,64), alpha=0.7)
plt.show()'''
